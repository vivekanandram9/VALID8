        ...
        <footer className="bg-black text-[#b1b8c2] py-6 ">
            <div className="container mx-auto px-4 flex flex-col items-center space-y-6">
                ...
                <div className="flex space-x-6">
                    {/* X (Twitter) */}
                    <a href="https://x.com/VivekAnandRam11" target="_blank" rel="noopener noreferrer">
                    ...
                    {/* GitHub */}
                    <a href="https://github.com/vivekanandram9" target="_blank" rel="noopener noreferrer">
            ...
            {/* Hover Effect Title */}
            <div className=" flex items-center justify-center bg-black h-[32rem] ">
                <TextHoverEffect className="" text="VALID8" />
            </div>
        </footer>
    )
}
