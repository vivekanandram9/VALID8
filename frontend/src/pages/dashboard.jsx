...
function Dashboard() {
  ...
  return (
    ...
    <div className="dashboardContainer  p-6 bg-[#181818] min-h-screen pl-[11rem] text-black ">
      <hr className="border-t  border-gray-300  left-0 top-[6rem] w-full fixed" />
      <DashboardHeader />
      
      <div className="flex gap-4 mb-4 mt-[15rem]">
        {/* Dropdown Menu */}
        <select
          value={dropdownValue}
        ...
        <input
          ...
          className="flex-grow px-4 text-black py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      ...
      {/* Tab Content */}
      <div className="bg-white p-4 border border-gray-300 rounded-lg shadow-md text-black " >
